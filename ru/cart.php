	...
	<?php if (isset($_SESSION['cart'])) : ?>
		...
		<div class="cart__content">
			<div class="container">
				...
				<input class="cart__content-comments" placeholder="Оставить комментарий" id="comments_inp">
				...
				<div class="cart__content-delivery">
					<h3 class="cart__delivery-title title">Информация о доставке</h3>
					...
					<div class="cart__delivery-address">
						...
						<input class="cart__address-input" placeholder="Адрес доставки" id="delivery_address" value="<?php echo $_COOKIE['address']; ?>">
					</div>
				...
				<div class="cart__content-order">
					<div class="cart__order-btn button" id="save_order_btn">
						Заказать <span id="order"><?php echo str_replace('.', ',', number_format($_SESSION['total_cart'], 2)) ?> €</span>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="modal__block" id="product_block">
				...
				<div class="modal__block-bottom">
					...
					<div class="modal__block-item modal__block-item--price button" id='add_product'>
						...
						<span id='add_product_text'>Обновить</span>
		...
		<div class="cart">
			...
			<div class="cart__empty">
				...
				<div class="cart__link-cart link__cart">
					<a class="link__cart-btn button link__cart-btn--search" href="index.php">Продолжить выбор</a>
				</div>
			</div>
